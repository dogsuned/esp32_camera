...
#define PIN_NUM_CLK  14     /*!< gpio number for LCD clock */
#define PIN_NUM_CS   0      /*!< gpio number for LCD CS */
#define PIN_NUM_DC   16     /*!< gpio number for LCD DC */
#define PIN_NUM_RST  15     /*!< gpio number for LCD RST */
#define PIN_NUM_BCKL 0      /*!< gpio number for LCD Back Light */
